...
public class EntityLinker {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		//
		// Map<String, List<String>> groundTruth = new HashMap<String,
		// List<String>>();
		// Map<String, List<String>> DBpediaentries = new HashMap<String,
		// List<String>>();
		//
		// groundTruth = retriveGroundTruth(paragraphsFile);
		// System.out.println("Paragraph entries retrieved..");
		//
		// System.out.println("Retrieving DBpedia Entries from
		// http://model.dbpedia-spotlight.org/ .....");
		// DBpediaentries = retriveDBpediaEntries(paragraphsFile);
		// System.out.println("Retrieved Dbpedia
		// entities.......................................... ");
		//
		// System.out.println("Computing F1 Measure for DBpedia
		// Spotlight...........................");
		// F1Measure f1 = new F1Measure();
		// List<Double> DBpediaSpotlight_EvaluationScore =
		// f1.evaluateMeasure(groundTruth, DBpediaentries);
		//
		// double score = 0.0;
		//
		...
		// }
		//
		// System.out.println("F1 Measure = " + (score /
		// DBpediaSpotlight_EvaluationScore.size()));

		// ****************************************************************************************/

		HyperLink hp = new HyperLink(args[1]);
